...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-7 min-h-screen items-center justify-center bg-linear-to-tr/hsl from-slate-50 from-20% to-slate-100 to-80%  font-sans px-6">
      <div id="lienzo_fijo" className="w-480 h-120 fixed top-0 left-1/2 -translate-x-1/2 pointer-events-none">

        <div id="derecha_atras" className="w-65 h-30 bg-amber-300 absolute z-0 rotate-75 top-70 left-265"></div>
        <div id="gordo_arriba" className="w-45 h-62 bg-lime-400 absolute z-0 rotate-15 top-48 left-233"></div>
        <div id="echado_arriba" className="w-58 h-30 bg-amber-300 absolute z-1 rotate-355 top-20 left-210"></div>
        <div id="cuadrado" className="w-45 h-62 bg-lime-400 absolute z-1 rotate-45 top-18 left-155"></div>
        <div id="cuadrado" className="w-35 h-35 bg-amber-300 absolute z-1 rotate-45 top-55 left-155"></div>
        <div id="cuadrado" className="w-45 h-62 bg-lime-400 absolute z-1 rotate-8 top-82 left-148"></div>
        <div id="flaco_central" className="w-13 h-60 bg-amber-300 absolute z-1 rotate-342 top-100 left-230"></div>
        <div id="largo_der" className="w-60 h-15 bg-amber-300 absolute z-2 rotate-25 top-135 left-262"></div>
        <div id="cuadrado" className="w-25 h-42 bg-lime-400 absolute z-3 rotate-0 top-110 left-285"></div>
        <div id="echado-ab" className="w-40 h-30 bg-lime-400 absolute z-3 rotate-15 top-170 left-185"></div>
        <div id="pequeño" className="w-15 h-35 bg-amber-300 absolute z-3 rotate-12 top-135 left-185"></div>
        <div id="echado_izq" className="w-25 h-50 bg-lime-400 absolute z-3 rotate-60 top-90 left-190"></div>
        <div id="gordo_abajo" className="w-45 h-60 bg-lime-400 absolute z-4 rotate-25 top-135 left-235"></div>
        <div id="echado_abajo" className="w-65 h-30 bg-amber-300 absolute z-4 rotate-355 top-185 left-175"></div>
          ...
          <div className="border-yellow-700 border-3 p-7 rounded-2xl">
            ...
            <div className="flex flex-col p-5">
              ...
              <div className="flex justify-center gap-5">
                <button className={`momo-trust-display-regular text-center text-cyan-600 text-base border-3 border-cyan-600 p-2 rounded-lg ${selectedModel == 0 ? "bg-cyan-300/25" : ""} hover:bg-white/30`}
                ...
                {/*<button className={`momo-trust-display-regular text-center text-orange-600 text-base border-3 border-orange-600 p-2 rounded-lg ${selectedModel == 1 ? "bg-orange-600/20" : ""} hover:bg-orange-600/15`}
